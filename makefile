...
SO_DIRS := -Wl,-rpath,includes/ogg -L/includes/ogg -llibogg -Wl,-rpath,includes/libopenal -L/includes/libopenal -lopenal -Wl,-rpath,includes/vorbis -L/includes/vorbis -lvorbisfile
SRC := ./src
